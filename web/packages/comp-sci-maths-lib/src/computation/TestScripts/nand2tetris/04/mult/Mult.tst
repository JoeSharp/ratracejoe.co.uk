...
compare-to Mult.cmp,
output-list RAM[0]%D2.6.2 RAM[1]%D2.6.2 RAM[16]%D2.6.2;

set RAM[0] 0,   // Set test arguments
set RAM[1] 0,
set RAM[16] -1;  // Test that program initialized product to 0
repeat 20 {
  ticktock;
}
...
set RAM[1] 0,
set RAM[16] -1;  // Ensure that program initialized product to 0
repeat 50 {
  ticktock;
}
