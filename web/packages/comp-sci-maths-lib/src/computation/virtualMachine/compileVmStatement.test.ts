...
describe("VM PseudoCode", () => {
  ...
  test("pop static i", () => {
    ...
    expect(
      vm.memory.labels[getStaticAsmVariable(TEST_FILENAME, 4)],
    ).toBeUndefined();
  });
  ...
  test("pop temp i", () => {
    ...
    runVmProgram(vm, "pop temp 0", "pop temp 3", "pop temp 6", "pop temp 7");
  ...
  test("pop pointer 0/1", () => {
    ...
    runVmProgram(vm, "pop pointer 0", "pop pointer 1");
  ...
  test("push pointer 0/1", () => {
    ...
    runVmProgram(vm, "push pointer 0", "push pointer 1");
