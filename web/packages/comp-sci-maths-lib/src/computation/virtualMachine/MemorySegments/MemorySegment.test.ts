import RAMSimulator, {
  VARIABLE_START,
} from "../../assemblyLanguage/RAMSimulator";
...
const createTestRam = () => {
  ...
  const stack: MemoryStack = new MemoryStack(
    memory,
    stackPointerAddress,
...
describe("Hack VM Memory Segment", () => {
  test("Array", () => {
    ...
    const segment = new MemoryArraySegment(
      memory,
      stack,
      "TEST",
      segmentAddressLocation,
      segmentAddress,
    );
  ...
  test("Constant", () => {
    ...
    expect(memory.getLabelled(ASM_MEM_SEG_SYMBOL_STACK_PTR)).toBe(
      stackPointerLocation + 3,
    );
  ...
  test("Pointer", () => {
    ...
    const thisSegment = new MemoryArraySegment(
      memory,
      stack,
      ASM_MEM_SEG_SYMBOL_THIS,
      thisSegmentLocation,
    ...
    const thatSegment = new MemoryArraySegment(
      memory,
      stack,
      ASM_MEM_SEG_SYMBOL_THAT,
      thatSegmentLocation,
    ...
    const pointerSegment = new MemorySegmentPointer(
      memory,
      stack,
      thisSegment,
      thatSegment,
