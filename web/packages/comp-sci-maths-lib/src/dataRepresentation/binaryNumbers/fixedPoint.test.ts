import { BinaryNumber, FloatingPointNumber, FixedPointNumber } from "./types";
...
import { binaryFromString, createBinaryNumber } from "./binaryIntegers";
...
describe("Fixed Point Numbers", () => {
  test("createFixedPointBinaryNumber", () => {
    ...
    expect(() => createFixedPointBinaryNumber(4, 8)).toThrow();
  });
