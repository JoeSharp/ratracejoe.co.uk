function AdventureEngine() {
  return (
    <div>
      ...
      <p>
        My son is currently building a text based adventure game in MakeCode
        Arcade and I would like to join in.
      </p>
      <p>
        I want to learn Go, and Rust. I have done somethings in Rust, but it
        intruiges me as a language.
      </p>
      <p>
